...
class BIQLParser:
    ...
    def parse(self) -> Query:
        ...
        if self._current_token_type() != TokenType.EOF and not self._is_clause_keyword():
        ...
        return Query(select_clause, where_clause, group_by, having, order_by, format_type)
    ...
    def _is_clause_keyword(self) -> bool:
        ...
        return self._current_token_type() in [
            TokenType.GROUP, TokenType.HAVING, TokenType.ORDER, TokenType.FORMAT
        ]
    ...
    def _parse_and(self) -> Expression:
        ...
        while (self._current_token_type() == TokenType.AND or 
               (self._current_token_type() in [TokenType.IDENTIFIER, TokenType.LPAREN, TokenType.NOT] and
                not self._is_clause_keyword())):
    ...
    def _parse_comparison(self) -> Expression:
        ...
        if self._current_token_type() in [TokenType.EQ, TokenType.NEQ, TokenType.GT, 
                                         TokenType.LT, TokenType.GTE, TokenType.LTE, 
                                         TokenType.MATCH, TokenType.IN, TokenType.LIKE]:
